...
import com.smartworldarafath.omnidailer.controller.util.SocialUtils
                            ...
                            Column(
                                ...
                                Row(
                                    ...
                                    Box(modifier = Modifier.weight(1f)) {
                                        RivoListItem(
                                            headline = com.smartworldarafath.omnidailer.controller.util.ContactUtils.formatContactName(contact.name, displayOrder),
